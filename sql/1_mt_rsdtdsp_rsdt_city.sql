CREATE TABLE mt_rsdtdsp_rsdt_city (
  全国地方公共団体コード text,
  町字id text,
  街区id text,
  住居id text,
...
CREATE TABLE mt_rsdtdsp_rsdt_pos_city (
  全国地方公共団体コード text,
  町字id text,
  街区id text,
  住居id text,
...
CREATE MATERIALIZED VIEW mt_rsdtdsp_rsdt_combined_city AS
SELECT
  ...
  p."住居表示住所_データ整備日"
FROM
  mt_rsdtdsp_rsdt_city addr
LEFT JOIN mt_rsdtdsp_rsdt_pos_city p ON 
